    ...
    public partial class Icon : ComponentBase
    {
        ...
        public static IconData Get(IconType type)
        {
            return type switch
            {
                ...
                IconType.Loading => GetIcon(fa.Spinner, "Loading", "og-loading-subtle og-color-primary", IconStyle.Solid),
                IconType.LoadingFullPage => GetIcon(fa.Spinner, "Loading", "og-loading-default og-color-primary", IconStyle.Solid),
                ...
                IconType.PatternWiggles => GetIcon(fa.Braille, "Pattern Wiggles"),
        ...
        protected override void OnParametersSet()
        {
            ...
            if (!string.IsNullOrEmpty(CustomIcon))
                customIconString = "fas " + CustomIcon;
        }
